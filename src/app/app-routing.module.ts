...
const routes: Routes = [
  ...
  { path: 'profile-details/:curentUser.email', component: ProfileDetailsComponent,  title:"Profile",canActivate: [UserGuard]},
  { path: 'docs', component: DocsComponent ,  title:"Home",canActivate: [UserGuard] },
